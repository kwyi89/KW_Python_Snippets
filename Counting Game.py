...
class Money:
    ...
    def display_intro():
        ...
        print('*' * 75)
        print('This is a simple money counting game to help kids learn '
              'to count money.')
    ...
    def start(self):
        """Randomly display an amount of change and ask how many of each coin type
        are need to equal the amount displayed."""
        self.display_intro()
...
def get_input_values(currency_amt):
    """Main logic of the program that tallies the value of each entered coin.
    Validation on the values entered is also performed.
    """
    quarter = 25
    dime = 10
    nickel = 5
